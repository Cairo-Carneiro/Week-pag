/**
 * Admin Page - Gestão de Palestras
 * Página exclusiva para administradores gerenciarem palestras
 * Migrado do App.tsx original
 */

import { useEffect, useState } from 'react';
import { useNavigate } from 'react-router-dom';
import { Calendar, TrendingUp, Lightbulb, LogOut, Plus, Home } from 'lucide-react';
          ...
          <section className="mb-12">
            <div className="flex items-center justify-between mb-6">
              <div className="flex items-center gap-3">
                ...
                <h2 className="text-3xl font-bold text-gray-900">Gerenciar Palestras</h2>
              </div>
              <div className="flex items-center gap-3">
                <ViewModeToggle />
                <button
