        ...
        set({
          error:
            error instanceof Error
              ? error.message
              : "Erro ao carregar responsabilidades",
          loading: false,
        });
      }
    },
      ...
      try {
        ...
        set({
          error:
            error instanceof Error
              ? error.message
              : "Erro ao criar responsabilidade",
          loading: false,
        });
        return null;
      }
      ...
      try {
        ...
        set({
          error:
            error instanceof Error
              ? error.message
              : "Erro ao atualizar responsabilidade",
          loading: false,
        });
      }
    },
    ...
    deleteResponsabilidade: async (id: string) => {
      ...
      try {
        ...
        if (success) {
          ...
          set((state) => ({
            responsabilidades: state.responsabilidades.filter(
              (r) => r.id !== id,
            ),
            loading: false,
          }));
        ...
        set({
          error:
            error instanceof Error
              ? error.message
              : "Erro ao deletar responsabilidade",
          loading: false,
        });
        return false;
      }
...
export const useResponsabilidadeCount = () => {
  return useResponsibilityStore((state) => ({
    ...
    critical: state.responsabilidades.filter((r) => r.critico && !r.completo)
      .length,
  }));
};
